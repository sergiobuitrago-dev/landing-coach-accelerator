        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg text-stone-300 mb-12">
            <p className="text-2xl font-semibold text-stone-100">
              "Sé entrenar mejor que muchos coaches que veo en
              redes..."
            </p>

            <p className="text-xl">
              "Pero ellos tienen clientes online, trabajan desde casa
              y yo sigo dependiendo del gimnasio."
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              {
                icon: "😓",
                title: "Cansado de cambiar tiempo por dinero",
                desc: "Si no estás en el gym, no facturas",
              },
              {
                icon: "📱",
                title: "Frustrado con las redes",
                desc: "Subes videos pero no llegan clientes",
              },
              {
                icon: "😰",
                title: "Miedo a hacer el ridículo",
                desc: "No quieres que te vean como un novato",
              },
            ].map((item, idx) => (
              <div
                key={idx}
          ...
          <div className="p-8 bg-gradient-to-r from-amber-300/10 to-teal-400/10 border border-amber-300/20 rounded-2xl">
            ...
            <p className="text-lg text-stone-300">
              ...
              <span className="text-amber-200 font-semibold">
                cómo convertir ese conocimiento en contenido que SÍ
                atrae clientes
              </span>{" "}
              sin perder tu identidad como coach profesional.
            </p>
          </div>
        </div>
      </div>
